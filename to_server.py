...
Modelli = [resnet50v3, resnet50v2, resnet50]  # Change index to select model

def run(model_name, training=True,):
    for MML_model in model_name:
...
if __name__ == "__main__":
    run(Modelli,training=True)  # Set to False to skip training and only evaluate
